...
INSERT INTO guests (pension_id, room_id, first_name, last_name, middle_name, birth_date, diet_type, character_notes, status) VALUES
  ('11111111-1111-1111-1111-111111111111', NULL, 'Николай',   'Кузнецов',  'Петрович',    '1945-03-15', 'Стол №5',     'Гипертония, утром принимает лекарства', 'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Татьяна',   'Соколова',  'Андреевна',   '1952-07-22', 'Без сахара',  'Диабет 2 типа, диета строгая',           'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Александр', 'Попов',     'Игоревич',    '1938-11-08', 'Обычный',     '',                                       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Елена',     'Новикова',  'Николаевна',  '1949-05-30', 'Стол №9',     'После операции, лёгкая пища',            'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Михаил',    'Федоров',   'Александрович','1941-09-12', 'Обычный',     '',                                       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Ольга',     'Морозова',  'Дмитриевна',  '1955-01-25', 'Без глютена', 'Аллергия на орехи',                      'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Сергей',    'Волков',    'Сергеевич',    '1936-04-18', 'Обычный',     '',                                       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Наталья',   'Лебедева',  'Павловна',    '1958-08-03', 'Стол №5',     '',                                       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Андрей',    'Козлов',    'Владимирович','1943-12-07', 'Обычный',     'Любит тишину, номер окном в сад',       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Ирина',     'Смирнова',  'Олеговна',    '1950-06-20', 'Без сахара',  '',                                       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Дмитрий',   'Орлов',     'Васильевич',  '1939-10-14', 'Обычный',     '',                                       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Марина',    'Белова',    'Ивановна',    '1947-02-28', 'Стол №9',     'Пожилая, нужна помощь с передвижением', 'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Евгений',   'Комаров',   'Николаевич',  '1944-07-06', 'Обычный',     '',                                       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Светлана',  'Тихонова',  'Александровна','1953-11-19', 'Без глютена', '',                                       'queue'),
  ('11111111-1111-1111-1111-111111111111', NULL, 'Виктор',    'Егоров',    'Петрович',    '1940-04-01', 'Стол №5',     '',                                       'queue');
