...
INSERT INTO guests (room_id, first_name, last_name, middle_name, birth_date, diet_type, character_notes, status) VALUES
  (NULL, 'Николай',   'Кузнецов',  'Петрович',    '1945-03-15', 'Стол №5',     'Гипертония, утром принимает лекарства', 'queue'),
  (NULL, 'Татьяна',   'Соколова',  'Андреевна',   '1952-07-22', 'Без сахара',  'Диабет 2 типа, диета строгая',           'queue'),
  (NULL, 'Александр', 'Попов',     'Игоревич',    '1938-11-08', 'Обычный',     '',                                       'queue'),
  (NULL, 'Елена',     'Новикова',  'Николаевна',  '1949-05-30', 'Стол №9',     'После операции, лёгкая пища',            'queue'),
  (NULL, 'Михаил',    'Федоров',   'Александрович','1941-09-12', 'Обычный',     '',                                       'queue'),
  (NULL, 'Ольга',     'Морозова',  'Дмитриевна',  '1955-01-25', 'Без глютена', 'Аллергия на орехи',                      'queue'),
  (NULL, 'Сергей',    'Волков',    'Сергеевич',    '1936-04-18', 'Обычный',     '',                                       'queue'),
  (NULL, 'Наталья',   'Лебедева',  'Павловна',    '1958-08-03', 'Стол №5',     '',                                       'queue'),
  (NULL, 'Андрей',    'Козлов',    'Владимирович','1943-12-07', 'Обычный',     'Любит тишину, номер окном в сад',       'queue'),
  (NULL, 'Ирина',     'Смирнова',  'Олеговна',    '1950-06-20', 'Без сахара',  '',                                       'queue'),
  (NULL, 'Дмитрий',   'Орлов',     'Васильевич',  '1939-10-14', 'Обычный',     '',                                       'queue'),
  (NULL, 'Марина',    'Белова',    'Ивановна',    '1947-02-28', 'Стол №9',     'Пожилая, нужна помощь с передвижением', 'queue'),
  (NULL, 'Евгений',   'Комаров',   'Николаевич',  '1944-07-06', 'Обычный',     '',                                       'queue'),
  (NULL, 'Светлана',  'Тихонова',  'Александровна','1953-11-19', 'Без глютена', '',                                       'queue'),
  (NULL, 'Виктор',    'Егоров',    'Петрович',    '1940-04-01', 'Стол №5',     '',                                       'queue');
...
BEGIN
  FOR r IN SELECT id FROM rooms WHERE status IN ('occupied','booked','checking_out_today') LOOP
    ...
    FOR i IN 1..n LOOP
      ...
      INSERT INTO maid_tasks (room_id, task_type, status) VALUES (r.id, t, st);
    END LOOP;
  END LOOP;
END$$;
